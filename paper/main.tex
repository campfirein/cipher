...
\midrule
w/o Tiered Retrieval   & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} \\
w/o OOD Detection      & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} \\
w/o Relation Graph     & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} & \todo{--} \\
\midrule
...
All queries are routed directly to the full agentic loop (Tier~4),
bypassing cache, direct MiniSearch response, and optimized LLM tiers.
\todo{Insert analysis after experiment.}

\paragraph{w/o OOD Detection.}
The out-of-domain rejection gate is disabled;
the system attempts to answer all queries regardless of relevance score.
\todo{Insert analysis after experiment.}

\paragraph{w/o Relation Graph.}
Explicit cross-entry relations (\texttt{@relation} annotations) are ignored
during retrieval, reducing the knowledge graph to isolated entries
without navigable inter-topic paths.
\todo{Insert analysis after experiment.}
