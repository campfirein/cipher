...
describe('Pull Command', () => {
  ...
  describe('validation', () => {
    it('should error when not authenticated', async () => {
      ...
      const command = new TestablePull(
        cogitPullService,
        contextTreeSnapshotService,
  ...
  describe('local changes detection', () => {
    it('should exit when there are local added changes', async () => {
      tokenStore.load.resolves(validToken)
    ...
    it('should exit when there are local modified changes', async () => {
      tokenStore.load.resolves(validToken)
      configStore.read.resolves(projectConfig)
    ...
    it('should exit when there are local deleted changes', async () => {
      tokenStore.load.resolves(validToken)
      configStore.read.resolves(projectConfig)
