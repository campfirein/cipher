...
describe('Process Tools', () => {
    ...
    describe('bash_exec', () => {
        it('should execute foreground command successfully', async () => {
            ...
            sandbox.assert.calledWith(processServiceMock.executeCommand, 'echo hello', sandbox.match({
                cwd: undefined,
        ...
        it('should execute background command successfully', async () => {
            ...
            sandbox.assert.calledWith(processServiceMock.executeCommand, 'sleep 10', sandbox.match({
                cwd: undefined,
                description: 'sleeping',
                runInBackground: true,
                timeout: undefined,
        ...
        it('should propagate invalid command error', async () => {
            ...
            try {
                ...
                expect(err.message).to.include('Invalid command')
            }
        })
    })
    ...
    describe('kill_process', () => {
        ...
        it('should handle kill failure gracefully', async () => {
            ...
            try {
                ...
                expect(err.message).to.include('kill')
            }
        })
    })
})
