...
describe('HttpSpaceService', () => {
  ...
  describe('getSpaces', () => {
    it('should fetch spaces successfully', async () => {
      ...
      const result = await service.getSpaces(accessToken, sessionKey)
    ...
    describe('pagination', () => {
      it('should fetch spaces with limit parameter', async () => {
        ...
        const result = await service.getSpaces(accessToken, sessionKey, {limit: 5})
      ...
      it('should fetch spaces with offset parameter', async () => {
        ...
        const result = await service.getSpaces(accessToken, sessionKey, {offset: 5})
      ...
      it('should fetch spaces with both limit and offset parameters', async () => {
        ...
        const result = await service.getSpaces(accessToken, sessionKey, {limit: 10, offset: 10})
      ...
      it('should fetch all spaces with fetchAll option', async () => {
        ...
        const result = await service.getSpaces(accessToken, sessionKey, {fetchAll: true})
