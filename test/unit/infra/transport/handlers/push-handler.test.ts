...
describe('PushHandler', () => {
  ...
  async function callPrepareHandler(clientId = 'client-1'): Promise<PushPrepareResponse> {
  ...
  async function callExecuteHandler(clientId = 'client-1'): Promise<PushExecuteResponse> {
  ...
  describe('handlePrepare – filtering', () => {
    it('should exclude files with pending review from fileCount', async () => {
      ...
      const result = await callPrepareHandler()
