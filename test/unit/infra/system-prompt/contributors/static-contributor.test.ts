...
import {PromptRenderer} from '../../../../../src/infra/cipher/resources/prompt-renderer.js'
import {PromptResourceLoader} from '../../../../../src/infra/cipher/resources/prompt-resource-loader.js'
...
describe('StaticContributor', () => {
  let mockResourceLoader: PromptResourceLoader
  let mockRenderer: PromptRenderer

  beforeEach(() => {
    mockResourceLoader = createStubInstance(PromptResourceLoader) as unknown as PromptResourceLoader
    mockRenderer = createStubInstance(PromptRenderer) as unknown as PromptRenderer
  })

  describe('constructor', () => {
    it('should create a static contributor with all properties', () => {
      const contributor = new StaticContributor('base-instructions', 1, mockResourceLoader, mockRenderer, 'You are a helpful assistant.')
    ...
    it('should create a contributor with different priorities', () => {
      const highPriority = new StaticContributor('high', 0, mockResourceLoader, mockRenderer, 'High priority content')
      const lowPriority = new StaticContributor('low', 100, mockResourceLoader, mockRenderer, 'Low priority content')
    ...
    it('should create a contributor with empty content', () => {
      const contributor = new StaticContributor('empty', 1, mockResourceLoader, mockRenderer, '')
  ...
  describe('getContent', () => {
    it('should return the static content', async () => {
      ...
      const contributor = new StaticContributor('test', 1, mockResourceLoader, mockRenderer, content)
...
- Be helpful`
    ...
    it('should return empty string for empty content', async () => {
      const contributor = new StaticContributor('test', 1, mockResourceLoader, mockRenderer, '')
...
\`\`\``
  ...
  describe('immutability', () => {
    it('should have id and priority properties', () => {
      const contributor = new StaticContributor('test-id', 42, mockResourceLoader, mockRenderer, 'content')
