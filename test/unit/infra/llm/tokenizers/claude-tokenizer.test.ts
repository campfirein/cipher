...
describe('ClaudeTokenizer', () => {
  ...
  describe('countTokens', () => {
    ...
    describe('sentence inputs', () => {
      ...
      it('should count tokens for medium sentence', () => {
        ...
        // 45 chars / 3.5 = 12.86 -> rounds up to 13
    ...
    describe('paragraph inputs', () => {
      it('should count tokens for paragraph', () => {
        ...
        expect(result).to.be.greaterThan(0)
        expect(result).to.equal(Math.ceil(text.length / 3.5))
      })
    })
    ...
    describe('code inputs', () => {
      it('should count tokens for JavaScript code', () => {
        ...
        // 37 chars / 3.5 = 10.57 -> rounds up to 11
  ...
  return x * 2;
        ...
        const result = tokenizer.countTokens(code)
        expect(result).to.equal(Math.ceil(code.length / 3.5))
      })
    })
    ...
    describe('mathematical consistency', () => {
      it('should use consistent character-to-token ratio', () => {
        const text1 = 'a'.repeat(35) // 35 chars -> 10 tokens
        const text2 = 'b'.repeat(35) // 35 chars -> 10 tokens
      ...
      it('should always round up (ceiling)', () => {
        // 3.5 chars = 1 token
        expect(tokenizer.countTokens('abc')).to.equal(1) // 3 / 3.5 = 0.86 -> 1
        ...
        // 8 chars = 3 tokens
        expect(tokenizer.countTokens('abcdefgh')).to.equal(3) // 8 / 3.5 = 2.29 -> 3
      })
    ...
    describe('edge cases', () => {
      it('should handle very long text', () => {
        ...
        expect(result).to.equal(Math.ceil(5000 / 3.5))
