...
import type {
  ...
  ToolSet,
} from '../../../../../../src/core/domain/cipher/tools/types.js'

import {KnownTool, ToolName} from '../../../../../../src/core/domain/cipher/tools/constants.js'
...
describe('cipher/tools', () => {
  ...
  describe('Runtime Constants - ToolName', () => {
    it('should have all expected tool name properties', () => {
      ...
      expect(ToolName.FIND_KNOWLEDGE_TOPICS).to.equal('find_knowledge_topics')
