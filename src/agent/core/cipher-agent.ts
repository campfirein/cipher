...
import type {AgentEventMap} from '../types/agent-events/types.js'
import type {GenerateResponse, StreamingEvent, StreamOptions} from '../types/streaming/types.js'
import type {BrvConfig} from '../../core/domain/entities/brv-config.js'
import type {CipherAgentServices} from '../interfaces/cipher-services.js'
import type {IChatSession} from '../interfaces/i-chat-session.js'
import type {AgentState, ExecutionContext, ICipherAgent} from '../interfaces/i-cipher-agent.js'
...
import {STREAMING_EVENT_NAMES} from '../types/streaming/types.js'
...
export class CipherAgent extends BaseAgent implements ICipherAgent {
  ...
  public async getSessionMetadata(
    sessionId: string,
  ): Promise<import('../types/storage/history-types.js').SessionMetadata | undefined> {
    this.ensureStarted()
