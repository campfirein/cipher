...
export interface MergeResult {
  ...
  added: string[]
  /**
   * Path to the pre-merge backup directory (.brv/context-tree-backup/).
   * The caller must delete this after all post-merge operations (e.g. saveSnapshotFromState)
   * complete successfully. On failure it is preserved for manual recovery.
   */
  backupDir: string
