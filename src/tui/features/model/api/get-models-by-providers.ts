...
import {ModelEvents, type ModelListByProvidersRequest, type ModelListByProvidersResponse} from '../../../../shared/transport/events/index.js'
...
export const getModelsByProviders = ({providerIds}: GetModelsByProvidersDTO): Promise<ModelListByProvidersResponse> => {
  ...
  return apiClient.request<ModelListByProvidersResponse, ModelListByProvidersRequest>(ModelEvents.LIST_BY_PROVIDERS, {providerIds})
}
