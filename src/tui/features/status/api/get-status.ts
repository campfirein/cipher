...
import {StatusEvents, type StatusGetRequest, type StatusGetResponse} from '../../../../shared/transport/events/index.js'
...
export const getStatus = (): Promise<StatusGetResponse> => {
  ...
  return apiClient.request<StatusGetResponse>(StatusEvents.GET, request)
}
