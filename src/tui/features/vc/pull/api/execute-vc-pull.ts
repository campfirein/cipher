...
import {type IVcPullRequest, type IVcPullResponse, VcEvents} from '../../../../../shared/transport/events/vc-events.js'
...
export const executeVcPull = (request?: IVcPullRequest): Promise<IVcPullResponse> => {
  ...
  return apiClient.request<IVcPullResponse>(VcEvents.PULL, request)
}
