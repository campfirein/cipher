      ...
      <Box flexDirection="column" paddingX={1}>
        ...
        {step === 'complete' && (
          <>
            ...
            <Box flexDirection="column" rowGap={1}>
              <Text color={colors.text}>Initialization complete! Your project is now set up with ByteRover.</Text>
              <EnterPrompt action="continue" active={mode === 'main'} onEnter={handleInitComplete} />
            </Box>
          </>
        )}
      </Box>
