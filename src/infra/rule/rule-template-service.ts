...
export class RuleTemplateService implements IRuleTemplateService {
  /**
   * Generates rule content for the specified agent.
...
`
  ...
  /**
   * Gets the ACE workflow guide content.
   * Content cloned from docs/ACE_AGENT_GUIDE.md
   * @returns The ACE guide content.
   */
  private getAceGuideContent(): string {
    return `# ACE Workflow Guide for Coding Agents
